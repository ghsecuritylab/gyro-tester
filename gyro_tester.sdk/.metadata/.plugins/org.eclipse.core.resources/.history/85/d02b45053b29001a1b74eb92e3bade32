...
/*
		for(Index = 0; Index < 2048; Index++){
			TxPacket[Index+2048] = (pattern1[Index*2]<<20) + (pattern1[Index*2+1]<<4);
		}
		for(Index = 0; Index < 2048; Index++){
			TxPacket[Index+4096] = (pattern2[Index*2]<<20) + (pattern2[Index*2+1]<<4);
		}
		for(Index = 0; Index < 2048; Index++){
			TxPacket[Index+6144] = (pattern3[Index*2]<<20) + (pattern3[Index*2+1]<<4);
		}
