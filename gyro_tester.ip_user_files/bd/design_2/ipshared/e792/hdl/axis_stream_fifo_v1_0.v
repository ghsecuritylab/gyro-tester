...
always @(posedge m00_axis_aclk) begin  
  ...
  assign dbg_word0_int = {21'b000000000000000000000, rd_ptr_reg};
  assign dbg_word1_int = {21'b000000000000000000000,rd_addr_reg};
  assign dbg_word2_int = {21'b000000000000000000000, wr_ptr_reg};
  assign dbg_word3_int = {21'b000000000000000000000,wr_addr_reg};
