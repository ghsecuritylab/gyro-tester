...
HD_PWD='C:/Xilinx_Projects/gyro_project/tester/tester.runs/design_2_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axi_smc_0.tcl
