...
HD_PWD='C:/Docs/gyro_tester/gyro_tester.runs/design_2_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_rst_ps7_0_100M_0.tcl
